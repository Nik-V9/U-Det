...
def generate_train_batches(root_path, train_list, net_input_shape, net, batchSize, numSlices=1, subSampAmt=-1,
    ...
    while True:
        ...
        for i, scan_name in enumerate(train_list):
            try:
                ...
                path_to_np_mask = join(root_path,'np_files','masks','masks_'+scan_name)
...
@threadsafe_generator
def generate_val_batches(root_path, val_list, net_input_shape, net, batchSize, numSlices=1, subSampAmt=-1,
...
@threadsafe_generator
def generate_test_batches(root_path, test_list, net_input_shape, batchSize, numSlices=1, subSampAmt=0,
